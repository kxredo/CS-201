...
// if leftChild < heap size (count) AND leftChild value is less than smallestChild value,
// smallestChild is leftChild
    if (leftChild < count && array[leftChild].getData() < array[smallestChild].getData()) {
        smallestChild = leftChild;
    }
// if rightChild < heap size (count) AND rightChild value is less than smallestChild value
// smallestChild is rightChild
